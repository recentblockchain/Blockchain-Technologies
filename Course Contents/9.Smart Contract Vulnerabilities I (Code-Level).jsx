...
describe("Reentrancy Exploit", () => {
    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'system-ui, sans-serif', backgroundColor: '#f5f5f5' }}>
            ...
            >
                <h3 style={{ marginTop: 0, marginBottom: '20px' }}>Smart Contract Vulnerabilities I</h3>
                ...
                {sections.map((section, idx) => (
                    <button
                        ...
                        style={{
                            ...
                            padding: '12px',
                            marginBottom: '8px',
                            background: currentSection === section.id ? '#3498db' : 'transparent',
                            color: 'white',
                            border: 'none',
                            borderRadius: '4px',
                            cursor: 'pointer',
