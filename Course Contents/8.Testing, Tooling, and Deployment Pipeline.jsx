...
const MODULE = {
    ...
    abstract: "A comprehensive guide to professional-grade smart contract testing, deployment rigor, and reliable Web3 client interactions. This module bridges local development to mainnet safety through deterministic test strategies, environment hygiene, on-chain event design, and operational excellence.",
    learningObjectives: [
        "Design and implement multi-layer test strategies (unit, integration, system tests) for smart contracts",
        "Practice test organization, fixtures, coverage analysis, and identify coverage limits",
        "Understand mock vs fork tradeoffs and apply fuzz/property-based and invariant testing",
        "Apply deployment safety: scripts, verification, versioning, upgrade patterns, and runbooks",
        "Design event schemas for reliability; handle reorgs, finality, and exactly-once semantics in client code",
        "Execute a reproducible testnet deployment with CI automation and smoke testing",
    ],
    prerequisites: "Modules 1–5: Solidity fundamentals, contract design patterns, security patterns, and Ethereum architecture.",
    keyTerms: [
        "Unit test vs integration test vs system test",
        "Test fixture and deterministic test data",
        "Code coverage and coverage limitations",
        "Mock vs mainnet fork",
        "Fuzz testing / property-based testing",
        "Invariant testing",
        "CI/CD mindset",
        "Flaky test",
        "Deployment script and artifact",
        "Contract verification and explorer",
        "Secrets hygiene and key rotation",
        "Smoke test and rollback",
        "Event schema and indexed topics",
        "Event-driven vs call-driven reads",
        "Reorg and finality",
...
const SECTIONS = [
    {
        id: "intro",
        title: "1. Introduction: Why Testing and Deployment Matter",
        content: `Smart contracts are immutable, permissionless, and handle real value. A single bug can lock funds forever. 
...
• Defensive design: Assume networks fail, keys leak, and timelines slip.`,
        quiz: [
            {
                type: "conceptual",
                question: "Why is replicating a production deployment manually for each release dangerous?",
                options: [
                    "It is not dangerous; manual work is always reliable.",
                    "Human error compounds with each step; implicit knowledge is lost; rollback becomes unclear.",
                    "Because Foundry is faster.",
                    "Because test coverage is irrelevant in production.",
                ],
                correct: 1,
                explanation: "Manual deployment introduces human-in-the-loop error, knowledge silos, and inconsistent state. The next engineer who deploys will not know what the first one did.",
            },
        ],
    },
    {
        id: "part1",
        title: "2. Professional Workflow and Test Strategy",
        subsections: [
            {
                id: "2.1",
                title: "2.1 The Test Pyramid",
                content: `Tests are organized in layers, from fast and numerous (unit) to slow and few (system):
...
KEY TAKEAWAY: The pyramid inverts risk: most tests should run fast locally; fewest tests should hit the blockchain.`,
                quiz: [
                    {
                        type: "multiselect",
                        question: "Which of the following are typical characteristics of unit tests?",
                        options: [
                            "A. Interact with a mainnet fork",
                            "B. Run in milliseconds",
                            "C. Test a single function with mocks",
                            "D. Can be run without a blockchain",
                            "E. Require real testnet funds",
                        ],
                        correct: [1, 2, 3],
                        explanation: "Unit tests are fast, isolated, and use mocks. They do not require a blockchain or testnet funds. They catch errors early.",
                    },
                ],
            },
            {
                id: "2.2",
                title: "2.2 Test Organization: Files, Fixtures, and Determinism",
                content: `A well-organized test suite is easy to extend and debug:
...
KEY TAKEAWAY: Write setUp() with a single, self-contained fixture. Never mutate it across tests.`,
            },
            {
                id: "2.3",
                title: "2.3 Coverage: Metric and Limitation",
                content: `Code coverage is a useful metric but not a guarantee of correctness.
...
KEY TAKEAWAY: Use coverage as a guide, not a goal. Pair it with threat modeling and property testing.`,
                quiz: [
                    {
                        type: "shortanswer",
                        question: "You have 100% line coverage on a contract. What might you still be missing?",
                        sampleAnswer: "Logic errors in edge cases, contract interactions, invariants, reentry, and authorization failures. Coverage does not test reasoning.",
                        explanation: "Coverage measures execution, not correctness. A test can call a function and assign the result without checking it.",
                    },
                ],
            },
            {
                id: "2.4",
                title: "2.4 Mock vs Fork: A Detailed Tradeoff",
                content: `When testing a contract that calls an oracle or other protocol, should you mock the external contract or fork the real network?
...
KEY TAKEAWAY: Mocks catch logic bugs fast; forks catch integration bugs late. Use both.`,
            },
            {
                id: "2.5",
                title: "2.5 Fuzz and Property-Based Testing",
                content: `Fuzzing generates random inputs to find edge cases your brain did not think of.
...
KEY TAKEAWAY: Start fuzzing after unit tests pass. Use invariants for critical system properties.`,
            },
            {
                id: "2.6",
                title: "2.6 Mainnet-Fork Testing and CI Mindset",
                content: `A mainnet fork lets you test against real contracts and state without risking mainnet.
...
KEY TAKEAWAY: CI automates feedback; flaky tests compromise that feedback. Invest in making tests deterministic.`,
                quiz: [
                    {
                        type: "conceptual",
                        question: "You have a test that sometimes passes and sometimes fails depending on the order tests run. How should you fix it?",
                        options: [
                            "A. Disable it with @skip or skip() and add a TODO.",
                            "B. Increase the timeout.",
                            "C. Identify shared mutable state and isolate it in setUp().",
                            "D. Run it only on Monday.",
                        ],
                        correct: 2,
                        explanation: "Flaky tests are almost always caused by shared state or non-determinism in setUp. Isolate each test.",
                    },
                ],
            },
        ],
        postSectionQuiz: [
            {
                type: "multiselect",
                question: "Which statements about test organization are correct?",
                options: [
                    "A. Unit tests should use mocks and run in milliseconds.",
                    "B. Integration tests should never fork the network.",
                    "C. The test pyramid has most tests at the base (unit) and fewest at the top (system).",
                    "D. 100% code coverage guarantees no bugs.",
                    "E. Invariant testing checks properties that should always hold.",
                ],
                correct: [0, 2, 4],
                explanation: "A, C, E are correct. B is false (integration tests can use forks for slower tests). D is false (coverage is a metric, not a guarantee).",
            },
        ],
    },
    {
        id: "part2",
        title: "3. Deployment Rigor and Chain Safety",
        subsections: [
            {
                id: "3.1",
                title: "3.1 Deployment Scripts and Artifacts",
                content: `A deployment script is code that creates contracts, initializes state, and records the result.
...
KEY TAKEAWAY: A deployment script should be idempotent (safe to re-run) and emit machine-readable artifacts.`,
            },
            {
                id: "3.2",
                title: "3.2 Secrets Hygiene and Key Management",
                content: `Never hardcode private keys or RPC secrets in code.
...
KEY TAKEAWAY: Treat keys like active bombs. The fewer hands they touch, the safer you are.`,
            },
            {
                id: "3.3",
                title: "3.3 Contract Verification on Block Explorers",
                content: `Contract verification proves that the bytecode on-chain matches the published source code.
...
ETHERSCAN VERIFICATION (FOUNDRY):
    ...
    2. Or, verify manually after deployment:
         forge verify-contract 0x1234... Counter:\
...
KEY TAKEAWAY: Verify immediately after deployment, before leaving the chain. Automate verification in your deploy script.`,
                quiz: [
                    {
                        type: "conceptual",
                        question: "Why should you verify a contract immediately after deployment rather than later?",
                        options: [
                            "A. Verification is faster if done immediately.",
                            "B. Compiler versions, ABI encoding, and optimizer flags may change; verification will fail.",
                            "C. Etherscan has rate limits.",
                            "D. There is no difference; you can verify anytime.",
                        ],
                        correct: 1,
                        explanation: "Later, the compiler version, dependencies, and optimizer settings may change. Verification metadata relies on exact reproducibility.",
                    },
                ],
            },
            {
                id: "3.4",
                title: "3.4 Versioning, Artifacts, and Reproducible Builds",
                content: `A reproducible build means anyone can rebuild the exact bytecode without trust.
...
KEY TAKEAWAY: Tag every production deployment with an immutable git commit and bytecode hash.`,
            },
            {
                id: "3.5",
                title: "3.5 Upgrade Patterns and Safety",
                content: `Smart contracts are immutable, but patterns exist to upgrade logic safely.
...
KEY TAKEAWAY: Use upgradeable patterns only if you need them. Every layer of indirection is a bug surface.`,
            },
            {
                id: "3.6",
                title: "3.6 Deployment Checklist, Pre-Deploy Reviews, and Smoke Tests",
                content: `Before deploying to mainnet, follow a rigorous checklist.
...
KEY TAKEAWAY: A 1-hour pre-deploy review prevents a 10-million-dollar loss. Invest the time.`,
                quiz: [
                    {
                        type: "shortanswer",
                        question: "Why should you deploy to a testnet before mainnet, even if all tests pass?",
                        sampleAnswer: "Testnet catch configuration errors (wrong addresses, network ID), environment issues (RPC timeouts), and allow smoke testing before irreversible mainnet deployment.",
                        explanation: "Tests are hypothetical; testnet deployment is real. A configuration typo may not fail tests but will fail on testnet.",
                    },
                ],
            },
            {
                id: "3.7",
                title: "3.7 Incident Runbooks and Post-Mortems",
                content: `When things go wrong (and they will), a runbook guides the response.
...
KEY TAKEAWAY: Write a runbook while calm; follow it exactly when panicked.`,
            },
        ],
        postSectionQuiz: [
            {
                type: "conceptual",
                question: "You are about to deploy a contract that handles $10M. What is the most important step you should take?",
                options: [
                    "Run unit tests and push to mainnet immediately.",
                    "Complete a pre-deployment checklist, staging deployment, and 30-minute senior engineer review.",
                    "Ask an AI chatbot if the code looks correct.",
                    "Manually verify the bytecode on the blockchain.",
                ],
                correct: 1,
                explanation: "Code review, staging, and checklists catch errors before they cost millions. Automation is fast; rigor is irreplaceable.",
            },
        ],
    },
    {
        id: "part3",
        title: "4. On-Chain Events and Reliable Client Interactions",
        subsections: [
            {
                id: "4.1",
                title: "4.1 Event Design and Schema Discipline",
                content: `Events are the on-chain audit log and the bridge to off-chain systems.
...
KEY TAKEAWAY: Events are immutable history. Spend time on schema design; it compounds over your protocol's lifetime.`,
            },
            {
                id: "4.2",
                title: "4.2 Indexed Topics and Event Filtering",
                content: `Indexed fields are stored in the event signature, allowing efficient filtering.
...
KEY TAKEAWAY: Index fields you will query; do not index what you will never filter by.`,
            },
            {
                id: "4.3",
                title: "4.3 Event-Driven vs Call-Driven Reads",
                content: `Two strategies to sync off-chain state with on-chain state.
...
KEY TAKEAWAY: Event-driven is faster; call-driven is more trustworthy. Use both for confidence.`,
            },
            {
                id: "4.4",
                title: "4.4 Reorgs, Finality, and Safe Block Confirmation",
                content: `A reorg (re-organization) happens when a crypto network forks and one branch becomes the canonical chain.
...
KEY TAKEAWAY: Distinguish between "included" (in a block) and "finalized" (irreversible). Show users "finalized" state.`,
                quiz: [
                    {
                        type: "conceptual",
                        question: "You index a transfer event at block 100. One hour later, a 7-block reorg occurs, and the transfer is gone. How could you have prevented this?",
                        options: [
                            "A. Index only events from blocks >= current_head - 12.",
                            "B. Wait for block finality before using the event.",
                            "C. Continuously monitor for reorgs and rewind when detected.",
                            "D. All of the above.",
                        ],
                        correct: 3,
                        explanation: "All are correct practices. Indexing from conservative depth, waiting for finality, and monitoring for reorgs all reduce risk.",
                    },
                ],
            },
            {
                id: "4.5",
                title: "4.5 Idempotency and Nonce Management",
                content: `Distributed systems have failures. Idempotency makes retries safe.
...
KEY TAKEAWAY: Design operations to be idempotent. Use idempotency keys and on-chain checks to prevent double-spending.`,
            },
            {
                id: "4.6",
                title: "4.6 Transaction Lifecycle and Reliable Submission",
                content: `A transaction goes through states from submission to finality. Monitoring each state is critical.
...
KEY TAKEAWAY: Transactions are not final immediately. Monitor lifecycle states and respond to failures with retries or bumps.`,
            },
        ],
        postSectionQuiz: [
            {
                type: "multiselect",
                question: "Which of the following are true about events and finality?",
                options: [
                    "A. Events are immutable on-chain.",
                    "B. Events included in a block are finalized; they will never reorg.",
                    "C. An indexer should only sync events from blocks >= head - 12.",
                    "D. Indexed event fields can be filtered efficiently.",
                    "E. Event-driven reads are always more up-to-date than call-driven reads.",
                ],
                correct: [0, 2, 3],
                explanation: "A, C, D are true. B is false (reorgs can remove blocks). E is false (call-driven is more current; event-driven may lag blocks).",
            },
        ],
    },
    {
        id: "part4",
        title: "5. Hands-On Lab: Reproducible Testnet Deployment",
        subsections: [
            {
                id: "5.1",
                title: "5.1 Lab Setup and Goals",
...
DELIVERABLES:
    ...
    4. A partner confirms they can run your flow.`,
            },
            {
                id: "5.2",
                title: "5.2 Step 1: Contract and Tests",
                content: `Create a minimal contract with state and events.
...
All should pass.`,
            ...
            {
                id: "5.3",
                title: "5.3 Step 2: Deployment Script",
                content: `Create a script to deploy and initialize on testnet.
...
Record the contract address (example: 0xABC123...).`,
            },
            {
                id: "5.4",
                title: "5.4 Step 3: Verification on Etherscan",
                content: `After deployment, verify the contract.
...
Check on Etherscan:
    ...
    4. Click "Read Contract" to verify state (owner, totalDeposited).`,
            },
            {
                id: "5.5",
                title: "5.5 Step 4: Smoke Tests",
                content: `After verification, test the contract on testnet.
...
Run against testnet:
    forge test --fork-url $SEPOLIA_RPC_URL`,
            ...
            {
                id: "5.6",
                title: "5.5 Step 5: Reproducible README",
                content: `Create a README that another engineer can follow exactly.
...
**Timeouts**: Use a faster RPC endpoint or increase timeout in forge config.`,
            },
            {
                id: "5.7",
                title: "5.6 Step 6: Pair Review and Reproducibility",
                content: `Pair with another engineer to verify reproducibility.
...
Commit this note to git.`,
            },
        ],
        postSectionQuiz: [
            {
                type: "shortanswer",
                question: "After deploying your contract to Sepolia and verifying it on Etherscan, a partner says they cannot verify the contract on Etherscan. What could be wrong?",
                sampleAnswer: "Possible causes: compiler version mismatch, constructor arguments not recorded, optimizer settings different, or source code does not match. Check foundry.toml, verify.sh script, and re-run verification manually.",
                explanation: "Verification is deterministic; any difference in build environment or constructor args causes verification to fail.",
            },
        ],
    },
    {
        id: "part5",
        title: "6. Advanced Topic: Case Study and Failures",
        subsections: [
            {
                id: "6.1",
                title: "6.1 Mini Case Study: The Incorrect Chain ID Incident",
                content: `INCIDENT: Protocol X deployed a contract on mainnet, but the deployment script hardcoded the wrong chain ID check.
...
KEY TAKEAWAY: Review assumptions as carefully as you review logic.`,
            },
            {
                id: "6.2",
                title: "6.2 Mini Case Study: The Flaky Test That Hid a Regression",
                content: `INCIDENT: Contract Z's test suite had a flaky test that sometimes passed and sometimes failed.
...
KEY TAKEAWAY: Flaky tests are not just annoying; they hide bugs. Fix them.`,
            },
            {
                id: "6.3",
                title: "6.3 Mini Case Study: Event Schema Mismatch and Indexer Chaos",
                content: `INCIDENT: A protocol upgraded its transfer event schema without versioning.
...
KEY TAKEAWAY: Treat events as immutable contracts. Versioning is your friend.`,
            },
        ],
    },
    {
        id: "part6",
        title: "7. Summary and Key Takeaways",
        content: `This module covered three interconnected pillars of smart contract operations:
...
FINAL PRINCIPLE: In Web3, you cannot call a customer and fix a bug. Design like every deployment is your last.`,
    },
];
...
const FINAL_ASSESSMENT = [
    {
        type: "conceptual",
        question: "A contract handles $100M in user funds. What is the most critical thing to do before mainnet deployment?",
        options: [
            "Achieve 100% test coverage.",
            "Complete a thorough checklist, staging deploy, and senior engineer review.",
            "Use the most advanced testing tools (fuzz, invariant, formal verification).",
            "Deploy to a private testnet first.",
        ],
        correct: 1,
    },
    {
        type: "multiselect",
        question: "Which statements are true about event design?",
        options: [
            "A. Indexed fields are efficient for filtering.",
            "B. You can modify an event after deployment without consequence.",
            "C. Events are immutable; design them carefully.",
            "D. Over-indexing all fields is best practice.",
            "E. Events should include redundant data for context.",
        ],
        correct: [0, 2, 4],
    },
    {
        type: "shortanswer",
        question: "You discover a deployed contract has a bug. What steps should you take?",
        sampleAnswer: "1) Pause the contract if possible. 2) Notify users. 3) Spin up a fork and investigate. 4) Deploy a fix and test on testnet. 5) Follow the upgrade/rollback plan. 6) Monitor for 1 hour. 7) Post-mortem within 24 hours.",
        explanation: "A structured incident response minimizes damage and prevents recurrence.",
    },
    {
        type: "conceptual",
        question: "A reorg causes a transfer event to disappear. How could you have prevented showing it to users as 'finalized'?",
        options: [
            "You cannot; reorgs are random.",
            "Index only events from blocks >= head - 12 (conservative depth).",
            "Use call-driven reads instead of events.",
            "Wait for absolute finality (32 blocks on PoS).",
        ],
        correct: 1,
    },
];
...
export default function TestingDeploymentModule() {
    ...
    const handleFinalAnswer = (questionId, answer) => {
        setFinalAssessmentAnswers({ ...finalAssessmentAnswers, [questionId]: answer });
    };
    ...
    const calculateScore = (answers, questions) => {
        ...
        questions.forEach((q, idx) => {
            ...
            if (typeof q.correct === "number" && userAnswer === q.correct) {
                correct++;
            } else if (Array.isArray(q.correct) && JSON.stringify(userAnswer) === JSON.stringify(q.correct)) {
                correct++;
            }
        });
    ...
    const finalScore = calculateScore(
        Object.values(finalAssessmentAnswers),
        FINAL_ASSESSMENT
    );
    ...
    const renderQuiz = (quizzes, prefix) => {
        return (
            <div style={{ marginTop: "24px", paddingTop: "16px", borderTop: "2px solid #ddd" }}>
                <h4>✓ Self-Check Questions</h4>
                {quizzes.map((q, idx) => {
                    const qId = `${prefix}_q${idx}`;
                    const userAnswer = quizAnswers[qId];
                    const isAnswered = userAnswer !== undefined;
                    const isCorrect = Array.isArray(q.correct)
                        ? JSON.stringify(userAnswer) === JSON.stringify(q.correct)
                        : userAnswer === q.correct;

                    return (
                        <div key={qId} style={{ marginBottom: "16px", padding: "12px", backgroundColor: "#f9f9f9", borderRadius: "4px" }}>
                                ...
                                <div>
                                    {q.options.map((opt, optIdx) => (
                                        <label key={optIdx} style={{ display: "block", marginBottom: "8px" }}>
                                            <input
                                                type="checkbox"
                                                checked={Array.isArray(userAnswer) && userAnswer.includes(optIdx)}
                                                onChange={(e) => {
                                                    const arr = userAnswer || [];
                                                    handleQuizAnswer(qId, e.target.checked ? [...arr, optIdx] : arr.filter((i) => i !== optIdx));
                                                }}
                                                aria-label={opt}
                                            />
                                            {" "}{opt}
                                    ...
                                    {q.options.map((opt, optIdx) => (
                                        <label key={optIdx} style={{ display: "block", marginBottom: "8px" }}>
                                            <input
                                                ...
                                                onChange={() => handleQuizAnswer(qId, optIdx)}
                                                aria-label={opt}
                                            />
                                            {" "}{opt}
                                        </label>
                            ...
                            {isAnswered && showAnswers && (
                                <div style={{ marginTop: "8px", padding: "8px", backgroundColor: isCorrect ? "#d4edda" : "#f8d7da", borderRadius: "4px" }}>
        ...
        <div style={{display:"flex",height:"100vh",background:_C.bg0,color:_C.text,overflow:"hidden"}}>
            ...
            <div style={{width:218,background:_C.bg1,borderRight:`1px solid ${_C.border}`,display:"flex",flexDirection:"column",flexShrink:0,overflowY:"auto"}}>
                <div style={{padding:"18px 16px 14px",borderBottom:`1px solid ${_C.border}`}}>
                    ...
                    <div style={{fontFamily:_C.disp,fontSize:13,fontWeight:700,color:_C.textBright,lineHeight:1.25,letterSpacing:"0.05em"}}>Testing &amp; Deployment</div>
                    <div style={{display:"flex",alignItems:"center",gap:6,marginTop:10}}>
                        <div style={{width:5,height:5,borderRadius:"50%",background:_C.cyan,animation:"blink 1.8s ease infinite"}}/>
                        <span style={{fontFamily:_C.mono,fontSize:9,color:_C.textMuted}}>Chapter 8 · Live</span>
                    </div>
                </div>
                <div style={{ marginBottom: "16px" }}>
                    <p style={{ fontSize: "12px", color: "#666" }}>Progress: {progressPercent}%</p>
                ...
                {SECTIONS.map((sec,idx) => (
                    <button
                        ...
                        style={{
                            ...
                            background:currentSection===sec.id?_C.cyanFaint:"none",
                            border:"none",borderLeft:`3px solid ${currentSection===sec.id?_C.cyan:"transparent"}`,
                            cursor:"pointer",textAlign:"left",display:"flex",gap:10,alignItems:"center",transition:"all 0.15s"
                        }}
                    >
                        <span style={{fontFamily:_C.mono,fontSize:9,color:currentSection===sec.id?_C.cyan:_C.textMuted,minWidth:22}}>§{idx+1}</span>
                        <span style={{fontFamily:_C.body,fontSize:12,color:currentSection===sec.id?_C.textBright:_C.textMuted,lineHeight:1.3}}>{sec.title.split(":")[0]}</span>
                    </button>
                ))}
                </nav>
            </div>
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "38px 46px", maxWidth: 860, margin: "0 auto", width: "100%" }}>
                ...
                {currentSection === "intro" && (
                    <div style={{ marginBottom: "32px" }}>
                        ...
                        <p style={{ fontSize: "16px", lineHeight: "1.6", color: "#555" }}>
                            <strong>Abstract:</strong> {MODULE.abstract}
                        </p>
                        ...
                        <div style={{ marginTop: "24px" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                                {MODULE.keyTerms.map((term, i) => (
                                    <div key={i} style={{ fontSize: "13px", padding: "8px", backgroundColor: "#f9f9f9", borderRadius: "4px" }}>
                                        {term}
                                    </div>
                                ))}
                            </div>
                ...
                {section && currentSection !== "intro" && (
                    <div>
                        <h1>{section.title}</h1>
                        <p style={{ fontSize: "15px", lineHeight: "1.7", whiteSpace: "pre-wrap", color: "#444" }}>
                            {section.content}
                        </p>

                        {section.subsections &&
                            section.subsections.map((sub) => (
                                <div key={sub.id} style={{ marginTop: "32px" }}>
                                    <h2 style={{ borderLeft: "4px solid #4CAF50", paddingLeft: "12px", marginBottom: "12px" }}>
                                        {sub.title}
                                    </h2>
                                    <p style={{ fontSize: "14px", lineHeight: "1.7", whiteSpace: "pre-wrap", color: "#555" }}>
                                        {sub.content}
                                    </p>
                                    {sub.quiz && renderQuiz(sub.quiz, `${section.id}_${sub.id}`)}
                                </div>
                            ))}

                        {section.postSectionQuiz && renderQuiz(section.postSectionQuiz, `${section.id}_post`)}

                        {section.quiz && section.quiz.length > 0 && !section.subsections && renderQuiz(section.quiz, section.id)}
                    </div>
                )}

                {/* Final Assessment */}
                {currentSection === "part6" && (
                    <div style={{ marginTop: "40px", padding: "20px", backgroundColor: "#f0f8ff", borderRadius: "8px" }}>
                        <h2>Final Assessment</h2>
                        <p>
                            These questions synthesize the module. Answer honestly; your score is private feedback for learning.
                        </p>

                        {FINAL_ASSESSMENT.map((q, idx) => {
                            const qId = `final_${idx}`;
                            const userAnswer = finalAssessmentAnswers[qId];
                            const isAnswered = userAnswer !== undefined;
                            const isCorrect = Array.isArray(q.correct)
                                ? JSON.stringify(userAnswer) === JSON.stringify(q.correct)
                                : userAnswer === q.correct;
                            ...
                            return (
                                ...
                                >
                                            ...
                                            {q.options.map((opt, optIdx) => (
                                                <label key={optIdx} style={{ display: "block", marginBottom: "8px" }}>
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            const arr = userAnswer || [];
                                                            handleFinalAnswer(qId, e.target.checked ? [...arr, optIdx] : arr.filter((i) => i !== optIdx));
                                                        }}
                                                        aria-label={opt}
                                                    />
                                                    {" "}{opt}
                                            ...
                                            {q.options.map((opt, optIdx) => (
                                                <label key={optIdx} style={{ display: "block", marginBottom: "8px" }}>
                                                    <input
                                                        ...
                                                        name={qId}
                                                        checked={userAnswer === optIdx}
                                                        onChange={() => handleFinalAnswer(qId, optIdx)}
                                                        aria-label={opt}
                                                    />
                                                    {" "}{opt}
                                                </label>
                                    ...
                                    {q.type === "shortanswer" && (
                                        <textarea
                                            value={userAnswer || ""}
                                            onChange={(e) => handleFinalAnswer(qId, e.target.value)}
                                            style={{ width: "100%", minHeight: "80px", padding: "8px", fontFamily: "monospace" }}
                                            placeholder="Type your answer..."
                                            aria-label="Short answer"
                                        />
                                    )}
                                    {showFinalResults && isAnswered && (
                                        <div
                                            style={{
                                                marginTop: "12px",
                                                padding: "12px",
                                        ...
                                        >
                                            <p style={{ color: isCorrect ? "#155724" : "#721c24", fontWeight: "bold" }}>
                                                {isCorrect ? "✓ Correct!" : "✗ Review this."}
                                            </p>
                                            <p style={{ fontSize: "13px", color: isCorrect ? "#155724" : "#721c24" }}>
                                                {q.explanation}
                                            </p>
                                        </div>
                                    )}
                        ...
                        <button
                            ...
                            aria-label="Show final assessment results"
                        >
                            {showFinalResults ? "Hide Feedback" : "Show Feedback"}
                        </button>
                        ...
                        {showFinalResults && (
                            ...
                            >
                                <h3 style={{ color: "#2e7d32" }}>Assessment Score</h3>
                                <p style={{ fontSize: "32px", fontWeight: "bold", color: "#2e7d32" }}>
                                    {finalScore}%
                                </p>
                                <p style={{ marginTop: "12px", lineHeight: "1.6" }}>
                                    {finalScore >= 80 &&
                                        "Excellent! You have mastered the material. You are ready to deploy with confidence."}
                                    {finalScore >= 60 && finalScore < 80 &&
                                        "Good progress! Review the sections where you had difficulty, especially around incident response and event design."}
                                    {finalScore < 60 &&
                                        "Keep learning! Re-read sections on testing strategy, deployment checklists, and event finality. Practice with the lab."}
                                </p>
                            </div>
                        )}
                    </div>
                ...
                {/* Navigation Buttons */}
                <div style={{ marginTop: "40px", display: "flex", gap: "12px", justifyContent: "space-between" }}>
                    <button
                        onClick={handlePrev}
                        disabled={sectionIndex === 0}
                        style={{
                            padding: "10px 20px",
                            backgroundColor: sectionIndex === 0 ? "#ccc" : "#2196F3",
                            color: "white",
                            border: "none",
                            borderRadius: "4px",
                    ...
                    <button
                        ...
                        style={{
                            padding: "10px 20px",
                            backgroundColor: sectionIndex === SECTIONS.length - 1 ? "#ccc" : "#4CAF50",
                            color: "white",
                            border: "none",
                            borderRadius: "4px",
                ...
                {/* Footer */}
                <div style={{ marginTop: "60px", paddingTop: "20px", borderTop: "1px solid #ddd", fontSize: "12px", color: "#888" }}>
                    <h4>Further Reading</h4>
                    <ul style={{ lineHeight: "1.8" }}>
                        <li>Foundry Book: https://book.getfoundry.sh/</li>
                        <li>Hardhat Documentation: https://hardhat.org/</li>
                        <li>Ethereum Yellow Paper (reorg/finality): https://ethereum.org/en/developers/</li>
                        <li>The Graph: https://thegraph.com/ (event indexing)</li>
                        <li>Smart Contract Audit RFPs: CertiK, OpenZeppelin, Trail of Bits</li>
                    </ul>
                </div>
                </div>
            </div>
