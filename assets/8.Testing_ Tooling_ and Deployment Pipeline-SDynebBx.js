...
FINAL PRINCIPLE: In Web3, you cannot call a customer and fix a bug. Design like every deployment is your last.`}],M=[{type:"conceptual",question:"A contract handles $100M in user funds. What is the most critical thing to do before mainnet deployment?",options:["Achieve 100% test coverage.","Complete a thorough checklist, staging deploy, and senior engineer review.","Use the most advanced testing tools (fuzz, invariant, formal verification).","Deploy to a private testnet first."],correct:1},{type:"multiselect",question:"Which statements are true about event design?",options:["A. Indexed fields are efficient for filtering.","B. You can modify an event after deployment without consequence.","C. Events are immutable; design them carefully.","D. Over-indexing all fields is best practice.","E. Events should include redundant data for context."],correct:[0,2,4]},{type:"shortanswer",question:"You discover a deployed contract has a bug. What steps should you take?",sampleAnswer:"1) Pause the contract if possible. 2) Notify users. 3) Spin up a fork and investigate. 4) Deploy a fix and test on testnet. 5) Follow the upgrade/rollback plan. 6) Monitor for 1 hour. 7) Post-mortem within 24 hours.",explanation:"A structured incident response minimizes damage and prevents recurrence."},{type:"conceptual",question:"A reorg causes a transfer event to disappear. How could you have prevented showing it to users as 'finalized'?",options:["You cannot; reorgs are random.","Index only events from blocks >= head - 12 (conservative depth).","Use call-driven reads instead of events.","Wait for absolute finality (32 blocks on PoS)."],correct:1}];function H(){const[m,v]=y.useState("intro"),[W,K]=y.useState({}),[I,S]=y.useState({}),[w,R]=y.useState(!1),[E,N]=y.useState({}),[x,D]=y.useState(!1),s=p.find(t=>t.id===m),l=p.findIndex(t=>t.id===m),O=Math.round((l+1)/p.length*100),F=()=>{l<p.length-1&&v(p[l+1].id)},L=()=>{l>0&&v(p[l-1].id)},k=(t,i)=>{S({...I,[t]:i})},A=(t,i)=>{N({...E,[t]:i})},g=((t,i)=>{let n=0;return i.forEach((r,u)=>{const a=t[u];(typeof r.correct=="number"&&a===r.correct||Array.isArray(r.correct)&&JSON.stringify(a)===JSON.stringify(r.correct))&&n++}),Math.round(n/i.length*100)})(Object.values(E),M),j=()=>{v("intro"),S({}),N({}),D(!1),R(!1)},T=(t,i)=>e.jsxs("div",{style:{marginTop:"24px",paddingTop:"16px",borderTop:"2px solid #ddd"},children:[e.jsx("h4",{children:"✓ Self-Check Questions"}),t.map((n,r)=>{const u=`${i}_q${r}`,a=I[u],h=a!==void 0,c=Array.isArray(n.correct)?JSON.stringify(a)===JSON.stringify(n.correct):a===n.correct;return e.jsxs("div",{style:{marginBottom:"16px",padding:"12px",backgroundColor:"#f9f9f9",borderRadius:"4px"},children:[e.jsx("p",{style:{fontWeight:"bold"},children:n.question}),n.type==="multiselect"&&e.jsx("div",{children:n.options.map((f,d)=>e.jsxs("label",{style:{display:"block",marginBottom:"8px"},children:[e.jsx("input",{type:"checkbox",checked:Array.isArray(a)&&a.includes(d),onChange:C=>{const P=a||[];k(u,C.target.checked?[...P,d]:P.filter(B=>B!==d))},"aria-label":f})," ",f]},d))}),n.type==="conceptual"&&e.jsx("div",{children:n.options.map((f,d)=>e.jsxs("label",{style:{display:"block",marginBottom:"8px"},children:[e.jsx("input",{type:"radio",name:u,checked:a===d,onChange:()=>k(u,d),"aria-label":f})," ",f]},d))}),n.type==="shortanswer"&&e.jsx("textarea",{value:a||"",onChange:f=>k(u,f.target.value),style:{width:"100%",minHeight:"80px",padding:"8px",fontFamily:"monospace"},placeholder:"Type your answer...","aria-label":"Short answer"}),h&&w&&e.jsxs("div",{style:{marginTop:"8px",padding:"8px",backgroundColor:c?"#d4edda":"#f8d7da",borderRadius:"4px"},children:[e.jsx("p",{style:{color:c?"#155724":"#721c24"},children:c?"✓ Correct!":"✗ Review this."}),e.jsx("p",{children:n.explanation})]})]},u)})]});return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:Y+z}),e.jsxs("div",{style:{display:"flex",height:"100vh",background:o.bg0,color:o.text,overflow:"hidden"},children:[e.jsxs("div",{style:{width:218,background:o.bg1,borderRight:`1px solid ${o.border}`,display:"flex",flexDirection:"column",flexShrink:0,overflowY:"auto"},children:[e.jsxs("div",{style:{padding:"18px 16px 14px",borderBottom:`1px solid ${o.border}`},children:[e.jsx("div",{style:{fontFamily:o.mono,fontSize:8,color:o.textMuted,letterSpacing:"0.24em",textTransform:"uppercase",marginBottom:8},children:"ACM Educational Series"}),e.jsx("div",{style:{fontFamily:o.disp,fontSize:13,fontWeight:700,color:o.textBright,lineHeight:1.25,letterSpacing:"0.05em"},children:"Testing & Deployment"}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6,marginTop:10},children:[e.jsx("div",{style:{width:5,height:5,borderRadius:"50%",background:o.cyan,animation:"blink 1.8s ease infinite"}}),e.jsx("span",{style:{fontFamily:o.mono,fontSize:9,color:o.textMuted},children:"Chapter 8 · Live"})]})]}),e.jsxs("div",{style:{marginBottom:"16px"},children:[e.jsxs("p",{style:{fontSize:"12px",color:"#666"},children:["Progress: ",O,"%"]}),e.jsx("div",{style:{width:"100%",height:"8px",backgroundColor:"#ddd",borderRadius:"4px",overflow:"hidden"},children:e.jsx("div",{style:{height:"100%",width:`${O}%`,backgroundColor:"#4CAF50",transition:"width 0.3s"}})})]}),e.jsx("nav",{style:{flex:1,overflowY:"auto",padding:"6px 0"},children:p.map((t,i)=>e.jsxs("button",{onClick:()=>v(t.id),style:{width:"100%",padding:"9px 14px",background:m===t.id?o.cyanFaint:"none",border:"none",borderLeft:`3px solid ${m===t.id?o.cyan:"transparent"}`,cursor:"pointer",textAlign:"left",display:"flex",gap:10,alignItems:"center",transition:"all 0.15s"},children:[e.jsxs("span",{style:{fontFamily:o.mono,fontSize:9,color:m===t.id?o.cyan:o.textMuted,minWidth:22},children:["§",i+1]}),e.jsx("span",{style:{fontFamily:o.body,fontSize:12,color:m===t.id?o.textBright:o.textMuted,lineHeight:1.3},children:t.title.split(":")[0]})]},t.id))})]}),e.jsx("div",{style:{flex:1,overflowY:"auto",padding:"38px 46px",maxWidth:860,margin:"0 auto",width:"100%"},children:e.jsxs("div",{className:"m4",children:[m==="intro"&&e.jsxs("div",{style:{marginBottom:"32px"},children:[e.jsx("h1",{children:b.title}),e.jsxs("p",{style:{fontSize:"16px",lineHeight:"1.6",color:"#555"},children:[e.jsx("strong",{children:"Abstract:"})," ",b.abstract]}),e.jsxs("div",{style:{marginTop:"24px"},children:[e.jsx("h3",{children:"Learning Objectives"}),e.jsx("ul",{style:{lineHeight:"1.8"},children:b.learningObjectives.map((t,i)=>e.jsx("li",{children:t},i))})]}),e.jsxs("div",{style:{marginTop:"24px"},children:[e.jsx("h3",{children:"Prerequisites"}),e.jsx("p",{children:b.prerequisites})]}),e.jsxs("div",{style:{marginTop:"24px"},children:[e.jsx("h3",{children:"Key Terms"}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px"},children:b.keyTerms.map((t,i)=>e.jsx("div",{style:{fontSize:"13px",padding:"8px",backgroundColor:"#f9f9f9",borderRadius:"4px"},children:t},i))})]})]}),s&&m!=="intro"&&e.jsxs("div",{children:[e.jsx("h1",{children:s.title}),e.jsx("p",{style:{fontSize:"15px",lineHeight:"1.7",whiteSpace:"pre-wrap",color:"#444"},children:s.content}),s.subsections&&s.subsections.map(t=>e.jsxs("div",{style:{marginTop:"32px"},children:[e.jsx("h2",{style:{borderLeft:"4px solid #4CAF50",paddingLeft:"12px",marginBottom:"12px"},children:t.title}),e.jsx("p",{style:{fontSize:"14px",lineHeight:"1.7",whiteSpace:"pre-wrap",color:"#555"},children:t.content}),t.quiz&&T(t.quiz,`${s.id}_${t.id}`)]},t.id)),s.postSectionQuiz&&T(s.postSectionQuiz,`${s.id}_post`),s.quiz&&s.quiz.length>0&&!s.subsections&&T(s.quiz,s.id)]}),m==="part6"&&e.jsxs("div",{style:{marginTop:"40px",padding:"20px",backgroundColor:"#f0f8ff",borderRadius:"8px"},children:[e.jsx("h2",{children:"Final Assessment"}),e.jsx("p",{children:"These questions synthesize the module. Answer honestly; your score is private feedback for learning."}),M.map((t,i)=>{const n=`final_${i}`,r=E[n],u=r!==void 0,a=Array.isArray(t.correct)?JSON.stringify(r)===JSON.stringify(t.correct):r===t.correct;return e.jsxs("div",{style:{marginBottom:"20px",padding:"16px",backgroundColor:"white",borderRadius:"6px",border:"1px solid #ddd"},children:[e.jsxs("p",{style:{fontWeight:"bold",marginBottom:"12px"},children:[i+1,". ",t.question]}),t.type==="multiselect"&&e.jsx("div",{children:t.options.map((h,c)=>e.jsxs("label",{style:{display:"block",marginBottom:"8px"},children:[e.jsx("input",{type:"checkbox",checked:Array.isArray(r)&&r.includes(c),onChange:f=>{const d=r||[];A(n,f.target.checked?[...d,c]:d.filter(C=>C!==c))},"aria-label":h})," ",h]},c))}),t.type==="conceptual"&&e.jsx("div",{children:t.options.map((h,c)=>e.jsxs("label",{style:{display:"block",marginBottom:"8px"},children:[e.jsx("input",{type:"radio",name:n,checked:r===c,onChange:()=>A(n,c),"aria-label":h})," ",h]},c))}),t.type==="shortanswer"&&e.jsx("textarea",{value:r||"",onChange:h=>A(n,h.target.value),style:{width:"100%",minHeight:"80px",padding:"8px",fontFamily:"monospace"},placeholder:"Type your answer...","aria-label":"Short answer"}),x&&u&&e.jsxs("div",{style:{marginTop:"12px",padding:"12px",backgroundColor:a?"#d4edda":"#f8d7da",borderRadius:"4px"},children:[e.jsx("p",{style:{color:a?"#155724":"#721c24",fontWeight:"bold"},children:a?"✓ Correct!":"✗ Review this."}),e.jsx("p",{style:{fontSize:"13px",color:a?"#155724":"#721c24"},children:t.explanation})]})]},n)}),e.jsx("button",{onClick:()=>D(!x),style:{marginTop:"20px",padding:"10px 20px",backgroundColor:"#4CAF50",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",fontWeight:"bold"},"aria-label":"Show final assessment results",children:x?"Hide Feedback":"Show Feedback"}),x&&e.jsxs("div",{style:{marginTop:"20px",padding:"20px",backgroundColor:"#e8f5e9",borderRadius:"6px",border:"2px solid #4CAF50"},children:[e.jsx("h3",{style:{color:"#2e7d32"},children:"Assessment Score"}),e.jsxs("p",{style:{fontSize:"32px",fontWeight:"bold",color:"#2e7d32"},children:[g,"%"]}),e.jsxs("p",{style:{marginTop:"12px",lineHeight:"1.6"},children:[g>=80&&"Excellent! You have mastered the material. You are ready to deploy with confidence.",g>=60&&g<80&&"Good progress! Review the sections where you had difficulty, especially around incident response and event design.",g<60&&"Keep learning! Re-read sections on testing strategy, deployment checklists, and event finality. Practice with the lab."]})]})]}),e.jsxs("div",{style:{marginTop:"40px",display:"flex",gap:"12px",justifyContent:"space-between"},children:[e.jsx("button",{onClick:L,disabled:l===0,style:{padding:"10px 20px",backgroundColor:l===0?"#ccc":"#2196F3",color:"white",border:"none",borderRadius:"4px",cursor:l===0?"not-allowed":"pointer",fontWeight:"bold"},"aria-label":"Previous section",children:"← Previous"}),e.jsx("button",{onClick:()=>R(!w),style:{padding:"10px 20px",backgroundColor:"#FF9800",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",fontWeight:"bold"},"aria-label":"Toggle answer visibility",children:w?"Hide Answers":"Show Answers"}),e.jsx("button",{onClick:j,style:{padding:"10px 20px",backgroundColor:"#f44336",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",fontWeight:"bold"},"aria-label":"Reset module",children:"Reset Activity"}),e.jsx("button",{onClick:F,disabled:l===p.length-1,style:{padding:"10px 20px",backgroundColor:l===p.length-1?"#ccc":"#4CAF50",color:"white",border:"none",borderRadius:"4px",cursor:l===p.length-1?"not-allowed":"pointer",fontWeight:"bold"},"aria-label":"Next section",children:"Next →"})]}),e.jsxs("div",{style:{marginTop:"60px",paddingTop:"20px",borderTop:"1px solid #ddd",fontSize:"12px",color:"#888"},children:[e.jsx("h4",{children:"Further Reading"}),e.jsxs("ul",{style:{lineHeight:"1.8"},children:[e.jsx("li",{children:"Foundry Book: https://book.getfoundry.sh/"}),e.jsx("li",{children:"Hardhat Documentation: https://hardhat.org/"}),e.jsx("li",{children:"Ethereum Yellow Paper (reorg/finality): https://ethereum.org/en/developers/"}),e.jsx("li",{children:"The Graph: https://thegraph.com/ (event indexing)"}),e.jsx("li",{children:"Smart Contract Audit RFPs: CertiK, OpenZeppelin, Trail of Bits"})]})]})]})})]})]})}export{H as default};
