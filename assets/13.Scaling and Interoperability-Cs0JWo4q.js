...
3.5 Withdrawal latency
        ...
        For ZK rollup:
            ...
            - Total: ~10-15 min`})}),e.jsxs("p",{className:"text-sm mt-4 mb-4",children:[e.jsx("strong",{children:"Deliverable:"})," Fill out the template below and record your measurements."]}),e.jsx(G,{})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-xl font-semibold mb-3",children:"Lab 2: Risk Register for Cross-Chain Features"}),e.jsxs("div",{className:"bg-blue-50 p-4 border-l-4 border-blue-500 mb-4",children:[e.jsx("p",{className:"font-semibold text-blue-900",children:"Objective"}),e.jsx("p",{className:"text-sm text-blue-800",children:"Build a risk register for a sample bridge (lock-and-mint ERC20 bridge from Ethereum to a hypothetical L2, with a multisig validator set). Identify threats, quantify likelihood and impact, and propose mitigations."})]}),e.jsx("p",{className:"text-sm mb-4",children:"Use the template below. For each row, assess: likelihood (how plausible?), impact (what is the damage if it happens?), detection signals (how would we know?), and mitigations (how do we reduce risk?)."}),e.jsx(Z,{rows:d,setRows:f}),e.jsxs("div",{className:"mt-4 p-4 bg-gray-50 border rounded",children:[e.jsx("p",{className:"font-semibold mb-2",children:"Template: Add New Risk"}),e.jsx("textarea",{placeholder:`Asset: ...\r
Threat: ...\r
Attack Path: ...\r
Likelihood: ...\r
Impact: ...\r
...
Mitigation: ...\r
Residual Risk: ...\r
Owner: ...`,className:"w-full p-2 border rounded text-xs font-mono",rows:10,onKeyPress:i=>{var g,v,b,w,L,y,k,I,E,P,D,O,U,H,z,q,K,W;if(i.key==="Enter"&&i.ctrlKey){const j=i.currentTarget.value.split(`
`).filter(R=>R.trim()),Y={id:Math.max(...d.map(R=>R.id),0)+1,asset:((v=(g=j[0])==null?void 0:g.split(":")[1])==null?void 0:v.trim())||"",threat:((w=(b=j[1])==null?void 0:b.split(":")[1])==null?void 0:w.trim())||"",attackPath:((y=(L=j[2])==null?void 0:L.split(":")[1])==null?void 0:y.trim())||"",likelihood:((I=(k=j[3])==null?void 0:k.split(":")[1])==null?void 0:I.trim())||"",impact:((P=(E=j[4])==null?void 0:E.split(":")[1])==null?void 0:P.trim())||"",detectionSignal:((O=(D=j[5])==null?void 0:D.split(":")[1])==null?void 0:O.trim())||"",mitigation:((H=(U=j[6])==null?void 0:U.split(":")[1])==null?void 0:H.trim())||"",residualRisk:((q=(z=j[7])==null?void 0:z.split(":")[1])==null?void 0:q.trim())||"",owner:((W=(K=j[8])==null?void 0:K.split(":")[1])==null?void 0:W.trim())||""};f([...d,Y]),i.currentTarget.value=""}}})]})]}),e.jsxs("div",{className:"mt-6",children:[e.jsx("h3",{className:"text-xl font-semibold mb-3",children:"Challenge Extension: Message Format with Domain Separation"}),e.jsx("p",{className:"mb-3",children:"For advanced learners: Design a minimal cross-chain message format that includes replay protection and domain separation. Pseudocode:"}),e.jsx("div",{className:"bg-gray-100 p-4 font-mono text-xs overflow-x-auto",children:e.jsx("pre",{children:`// Minimal cross-chain message format
...
EXERCISE:
    ...
    d) Test that a message with old timestamp is rejected`})})]}),e.jsxs("div",{className:"flex gap-3 mt-6",children:[e.jsx("button",{onClick:()=>s("product-guidance"),className:"px-4 py-2 bg-gray-400 text-white rounded hover:bg-gray-500",children:"← Back"}),e.jsx("button",{onClick:()=>s("tabletop"),className:"px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700",children:"Next →"})]})]}):n==="tabletop"?e.jsxs("div",{className:"space-y-6",children:[e.jsx("h2",{className:"text-3xl font-bold",children:"6. Bridge Incident Tabletop Exercise"}),e.jsx("p",{className:"mb-4",children:"Work through a simulated bridge exploit scenario. Choose your bridge model, respond to security failures, and draft incident communications. This is text-based and collaborative."}),e.jsx(X,{scenario:F,currentStep:u,onNextStep:()=>c(u+1),onPrevStep:()=>c(Math.max(0,u-1))}),e.jsxs("div",{className:"flex gap-3 mt-6",children:[e.jsx("button",{onClick:()=>s("lab"),className:"px-4 py-2 bg-gray-400 text-white rounded hover:bg-gray-500",children:"← Back"}),e.jsx("button",{onClick:()=>s("final-assessment"),className:"px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700",children:"Next →"})]})]}):n==="final-assessment"?(t||B(),e.jsxs("div",{className:"space-y-6",children:[e.jsx("h2",{className:"text-3xl font-bold",children:"7. Final Assessment"}),e.jsx("p",{className:"mb-4",children:"Answer the following questions to test your understanding. These cover conceptual knowledge and scenario-based reasoning."}),e.jsx(Q,{questions:N["final-assessment"].questions,onSubmit:i=>{C("final-assessment",i);const g=B();a(g)},answers:o["final-assessment"]||{},showAnswers:h,score:t}),t&&e.jsxs("div",{className:"bg-blue-50 p-4 border-l-4 border-blue-500",children:[e.jsx("p",{className:"font-semibold text-blue-900 mb-2",children:"Score Summary"}),e.jsxs("p",{className:"text-sm text-blue-800",children:["You scored ",e.jsx("strong",{children:t.correct})," of"," ",e.jsx("strong",{children:t.total})," (",t.percentage,"%)"]}),t.percentage>=80&&e.jsx("p",{className:"text-sm text-green-800 mt-2 font-semibold",children:"✓ Excellent! You have strong grasp of scaling and interoperability concepts."}),t.percentage>=60&&t.percentage<80&&e.jsx("p",{className:"text-sm text-yellow-800 mt-2 font-semibold",children:"Good progress! Review weak areas below."}),t.percentage<60&&e.jsx("p",{className:"text-sm text-red-800 mt-2 font-semibold",children:"Keep studying. Revisit sections where you struggled."})]}),e.jsxs("div",{className:"flex gap-3 mt-6",children:[e.jsx("button",{onClick:()=>s("tabletop"),className:"px-4 py-2 bg-gray-400 text-white rounded hover:bg-gray-500",children:"← Back"}),t&&e.jsx("button",{onClick:()=>{a(null),l({}),c(0),s("intro")},className:"px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700",children:"Reset and Start Over"})]}),e.jsxs("div",{className:"mt-8 pt-8 border-t",children:[e.jsx("h3",{className:"text-xl font-semibold mb-4",children:"Further Reading and References"}),e.jsxs("div",{className:"text-sm space-y-2",children:[e.jsx("p",{children:e.jsx("strong",{children:"L1 Scaling Literature:"})}),e.jsxs("ul",{className:"list-disc list-inside space-y-1 ml-2",children:[e.jsx("li",{children:"Ethereum Roadmap: https://ethereum.org/en/roadmap/"}),e.jsx("li",{children:'Vitalik Buterin: "Endgame" (L2 centralization risks): https://vitalik.eth.limo/general/2024/05/09/endgame.html'})]}),e.jsx("p",{className:"mt-4",children:e.jsx("strong",{children:"Rollups:"})}),e.jsxs("ul",{className:"list-disc list-inside space-y-1 ml-2",children:[e.jsx("li",{children:"The Optimism Bedrock Upgrade Explanation: https://blog.optimism.io/introducing-bedrock/"}),e.jsx("li",{children:"StarkWare ZK Rollup Architecture: https://docs.starkware.co/starkex/index.html"}),e.jsx("li",{children:"Arbitrum Nitro: https://offchain.medium.com/arbitrum-nitro-rollup-architecture-7c89989dafb"})]}),e.jsx("p",{className:"mt-4",children:e.jsx("strong",{children:"Bridges and Cross-Chain:"})}),e.jsxs("ul",{className:"list-disc list-inside space-y-1 ml-2",children:[e.jsx("li",{children:"CrossChain Risk Framework (Chainalysis): https://go.chainalysis.com/l/476392/2023-10-11/d476nb"}),e.jsx("li",{children:"Ronin Bridge Exploit Post-Mortem (Sky Mavis): https://ronin.co/news/ronin-bridge-post-mortem"}),e.jsx("li",{children:"Poly Network Exploit Analysis (CertiK): https://www.certik.com/blog/post/poly-network-hack-4-root-causes-analysis"})]}),e.jsx("p",{className:"mt-4",children:e.jsx("strong",{children:"Operational Security:"})}),e.jsxs("ul",{className:"list-disc list-inside space-y-1 ml-2",children:[e.jsx("li",{children:"HSM Best Practices (Fireblocks): https://www.fireblocks.com/blog/"}),e.jsx("li",{children:"OWASP Cryptocurrency & Blockchain Security: https://owasp.org/www-community/attacks/"})]})]})]})]})):null;return e.jsxs("div",{className:"min-h-screen bg-white",children:[e.jsxs("div",{className:"max-w-7xl mx-auto flex",children:[e.jsxs("div",{className:"w-60 bg-gray-100 p-4 min-h-screen overflow-y-auto border-r",children:[e.jsxs("div",{className:"mb-6",children:[e.jsx("p",{className:"text-xs font-semibold text-gray-600 uppercase",children:"Progress"}),e.jsx("div",{className:"w-full bg-gray-300 rounded-full h-2 mt-2",children:e.jsx("div",{className:"bg-blue-600 h-2 rounded-full transition-all duration-300",style:{width:`${r}%`}})}),e.jsxs("p",{className:"text-xs text-gray-600 mt-1",children:[r,"% Complete"]})]}),e.jsx("nav",{className:"space-y-1",children:A.map(i=>e.jsx("button",{onClick:()=>s(i.id),className:`block w-full text-left px-4 py-2 rounded text-sm transition-colors ${n===i.id?"bg-blue-600 text-white font-semibold":"text-gray-700 hover:bg-gray-200"}`,"aria-current":n===i.id?"page":void 0,children:i.label},i.id))}),e.jsxs("div",{className:"mt-8 pt-4 border-t space-y-2",children:[e.jsxs("label",{className:"flex items-center text-sm",children:[e.jsx("input",{type:"checkbox",checked:S,onChange:i=>T(i.target.checked),className:"mr-2"}),e.jsx("span",{children:"Instructor Mode"})]}),S&&e.jsx("button",{onClick:()=>x(!h),className:"w-full px-3 py-2 text-xs bg-yellow-600 text-white rounded hover:bg-yellow-700",children:h?"Hide Answers":"Show Answers"}),e.jsx("button",{onClick:()=>{s("intro"),l({}),a(null),c(0)},className:"w-full px-3 py-2 text-xs bg-gray-400 text-white rounded hover:bg-gray-500",children:"Reset Activity"})]})]}),e.jsx("div",{className:"flex-1 p-8 overflow-y-auto",children:$()})]}),e.jsx(V,{})]})},M=({sectionId:n,questions:s,onSubmit:r,answers:m,showAnswers:o})=>{const[l,h]=p.useState(m),x=(a,u)=>{h(c=>({...c,[a]:u}))},t=(a,u)=>{h(c=>{var S;const d=((S=c[a])==null?void 0:S.selected)||[],f=d.includes(u)?d.filter(T=>T!==u):[...d,u];return{...c,[a]:{selected:f}}})};return e.jsxs("div",{className:"space-y-6",children:[s.map(a=>{var u;return e.jsxs("div",{className:"bg-white p-4 border rounded",children:[e.jsx("p",{className:"font-semibold text-sm mb-3",children:a.text}),a.type==="multiple-choice"&&e.jsx("div",{className:"space-y-2",children:a.options.map((c,d)=>{var f;return e.jsxs("label",{className:"flex items-start cursor-pointer",children:[e.jsx("input",{type:"radio",name:a.id,value:d,checked:(((f=l[a.id])==null?void 0:f.selected)||-1)===d,onChange:()=>x(a.id,{selected:d}),className:"mt-1 mr-2"}),e.jsx("span",{className:"text-sm",children:c.text})]},d)})}),a.type==="multi-select"&&e.jsx("div",{className:"space-y-2",children:a.options.map((c,d)=>{var f;return e.jsxs("label",{className:"flex items-start cursor-pointer",children:[e.jsx("input",{type:"checkbox",checked:(((f=l[a.id])==null?void 0:f.selected)||[]).includes(d),onChange:()=>t(a.id,d),className:"mt-1 mr-2"}),e.jsx("span",{className:"text-sm",children:c.text})]},d)})}),a.type==="short-answer"&&e.jsx("textarea",{value:((u=l[a.id])==null?void 0:u.text)||"",onChange:c=>x(a.id,{text:c.target.value}),placeholder:"Type your answer...",className:"w-full p-2 border rounded text-sm",rows:3}),o&&e.jsxs("div",{className:"mt-4 p-3 bg-green-50 border-l-2 border-green-500 text-xs text-green-800",children:[e.jsx("p",{className:"font-semibold",children:"Answer Explanation:"}),e.jsx("p",{className:"mt-1",children:a.explanation})]})]},a.id)}),e.jsx("button",{onClick:()=>r(l),className:"px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm",children:"Submit Answers"})]})},G=()=>{const[n,s]=p.useState({l1_gas:"",l1_price:"",l1_usd:"",arb_gas:"",arb_price:"",arb_usd:"",zk_gas:"",zk_price:"",zk_usd:"",l1_finality:"",arb_finality:"",zk_finality:""});return e.jsxs("div",{className:"bg-gray-50 p-4 border rounded",children:[e.jsx("p",{className:"font-semibold mb-4",children:"Cost Measurements (Fill in your results)"}),e.jsx("div",{className:"grid grid-cols-3 gap-4 text-xs mb-6",children:[{label:"L1 Gas Used",key:"l1_gas"},{label:"L1 Gas Price (gwei)",key:"l1_price"},{label:"L1 Cost (USD)",key:"l1_usd"},{label:"Arbitrum Gas",key:"arb_gas"},{label:"Arbitrum Price (gwei)",key:"arb_price"},{label:"Arbitrum Cost (USD)",key:"arb_usd"},{label:"zkSync Gas",key:"zk_gas"},{label:"zkSync Price (gwei)",key:"zk_price"},{label:"zkSync Cost (USD)",key:"zk_usd"}].map(({label:r,key:m})=>e.jsxs("div",{children:[e.jsx("label",{className:"block font-semibold mb-1",children:r}),e.jsx("input",{type:"text",value:n[m],onChange:o=>s(l=>({...l,[m]:o.target.value})),className:"w-full p-2 border rounded",placeholder:"0"})]},m))}),e.jsx("p",{className:"font-semibold mb-4",children:"Latency Measurements (seconds)"}),e.jsx("div",{className:"grid grid-cols-3 gap-4 text-xs",children:[{label:"L1 Soft Finality (sec)",key:"l1_finality"},{label:"Arbitrum Hard Finality (sec)",key:"arb_finality"},{label:"zkSync Hard Finality (sec)",key:"zk_finality"}].map(({label:r,key:m})=>e.jsxs("div",{children:[e.jsx("label",{className:"block font-semibold mb-1",children:r}),e.jsx("input",{type:"text",value:n[m],onChange:o=>s(l=>({...l,[m]:o.target.value})),className:"w-full p-2 border rounded",placeholder:"0"})]},m))}),e.jsx("button",{onClick:()=>{alert(`Results saved:
`+JSON.stringify(n,null,2))},className:"mt-4 px-4 py-2 bg-green-600 text-white rounded text-xs hover:bg-green-700",children:"Save Measurements"})]})},Z=({rows:n,setRows:s})=>e.jsxs("div",{className:"overflow-x-auto bg-gray-50 border rounded p-4 mb-4",children:[e.jsxs("table",{className:"w-full text-xs border-collapse",children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-gray-200",children:["Asset","Threat","Attack Path","Likelihood","Impact","Detection","Mitigation","Residual","Owner"].map(r=>e.jsx("th",{className:"border p-2 text-left",children:r},r))})}),e.jsx("tbody",{children:n.map(r=>e.jsxs("tr",{className:"border-b hover:bg-gray-100",children:[e.jsx("td",{className:"border p-2",children:r.asset}),e.jsx("td",{className:"border p-2",children:r.threat}),e.jsx("td",{className:"border p-2",children:r.attackPath}),e.jsx("td",{className:"border p-2",children:r.likelihood}),e.jsx("td",{className:"border p-2",children:r.impact}),e.jsx("td",{className:"border p-2",children:r.detectionSignal}),e.jsx("td",{className:"border p-2",children:r.mitigation}),e.jsx("td",{className:"border p-2",children:r.residualRisk}),e.jsx("td",{className:"border p-2",children:r.owner})]},r.id))})]}),e.jsx("button",{onClick:()=>{const r=[["Asset","Threat","Attack Path","Likelihood","Impact","Detection","Mitigation","Residual","Owner"],...n.map(o=>[o.asset,o.threat,o.attackPath,o.likelihood,o.impact,o.detectionSignal,o.mitigation,o.residualRisk,o.owner])].map(o=>o.map(l=>`"${l}"`).join(",")).join(`
`),m=document.createElement("a");m.href="data:text/csv;charset=utf-8,"+encodeURIComponent(r),m.download="risk_register.csv",m.click()},className:"mt-4 px-4 py-2 bg-blue-600 text-white rounded text-xs hover:bg-blue-700",children:"Export as CSV"})]}),X=({scenario:n,currentStep:s,onNextStep:r,onPrevStep:m})=>{const[o,l]=p.useState({}),h=n.steps[s];return h?e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"bg-blue-50 p-4 border-l-4 border-blue-500",children:[e.jsxs("p",{className:"font-semibold text-blue-900",children:["Phase: ",h.phase]}),e.jsx("p",{className:"text-sm text-blue-800 mt-2",children:h.text})]}),h.options&&e.jsx("div",{className:"space-y-3",children:h.options.map((x,t)=>e.jsxs("label",{className:"flex items-start p-3 border rounded hover:bg-gray-50 cursor-pointer",children:[e.jsx("input",{type:"radio",name:`step-${s}`,value:t,checked:(o[s]||-1)===t,onChange:()=>l(a=>({...a,[s]:t})),className:"mt-1 mr-3"}),e.jsxs("div",{children:[e.jsx("p",{className:"font-semibold text-sm",children:x.text}),x.notes&&e.jsx("p",{className:"text-xs text-gray-600 mt-1",children:x.notes})]})]},t))}),h.template&&e.jsx("div",{className:"bg-gray-100 p-4 font-mono text-xs overflow-auto rounded border",children:e.jsx("pre",{children:h.template})}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("button",{onClick:m,disabled:s===0,className:"px-4 py-2 bg-gray-400 text-white rounded hover:bg-gray-500 disabled:opacity-50",children:"← Back"}),e.jsx("button",{onClick:r,className:"px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700",children:"Next →"})]})]}):e.jsxs("div",{className:"bg-green-50 p-4 border-l-4 border-green-500",children:[e.jsx("p",{className:"font-semibold text-green-900",children:"Tabletop Complete"}),e.jsx("p",{className:"text-sm text-green-800 mt-2",children:"You have completed the bridge incident tabletop exercise. Key takeaways: choose your trust model carefully, implement monitoring before incidents, and have an incident response plan ready."})]})},Q=({questions:n,onSubmit:s,answers:r,showAnswers:m,score:o})=>{const[l,h]=p.useState(r),x=(t,a)=>{h(u=>({...u,[t]:a}))};return e.jsxs("div",{className:"space-y-6",children:[n.map(t=>{var a;return e.jsxs("div",{className:"bg-white p-4 border rounded",children:[e.jsx("p",{className:"font-semibold text-sm mb-3",children:t.text}),t.type==="multiple-choice"&&e.jsx("div",{className:"space-y-2",children:t.options.map((u,c)=>{var d;return e.jsxs("label",{className:"flex items-start cursor-pointer",children:[e.jsx("input",{type:"radio",name:t.id,value:c,checked:(((d=l[t.id])==null?void 0:d.selected)||-1)===c,onChange:()=>x(t.id,{selected:c}),className:"mt-1 mr-2"}),e.jsx("span",{className:"text-sm",children:u.text})]},c)})}),(t.type==="scenario"||t.type==="short-answer")&&e.jsx("textarea",{value:((a=l[t.id])==null?void 0:a.text)||"",onChange:u=>x(t.id,{text:u.target.value}),placeholder:"Type your response...",className:"w-full p-2 border rounded text-sm font-serif",rows:4}),m&&e.jsxs("div",{className:"mt-4 p-3 bg-green-50 border-l-2 border-green-500 text-xs text-green-800",children:[e.jsx("p",{className:"font-semibold",children:"Sample Answer / Explanation:"}),e.jsx("p",{className:"mt-1 whitespace-pre-wrap",children:t.explanation})]})]},t.id)}),!o&&e.jsx("button",{onClick:()=>s(l),className:"px-6 py-2 bg-green-600 text-white rounded hover:bg-green-700 font-semibold",children:"Submit Assessment"})]})};export{se as default};
